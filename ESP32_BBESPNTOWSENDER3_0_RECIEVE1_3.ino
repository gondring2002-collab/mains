...
#include <WiFi.h>
 ...
 #define HX711_SCK 4
 HX711 scale;
float kalC = -7050;   // calibration factor HX711
float kalA = 1.0;     // slope
float kalB = 0.0;     // offset
...
if (dataMasuk.nodeID == 83)
{
    ...
    long netRaw = raw - scale.get_offset();
