...
volatile float beratBerdiri = 0;
volatile float beratBerbaring = 0;
...
if(incomingData.nodeID == 2)
  ...
  */
  ...
  // Semua data tetap diterima
if (incomingData.nodeID == 2)
{
    beratBerdiri = incomingData.value;
    Serial.print("BeratBerdiro : ");
    Serial.println(beratBerdiri);
}

if (incomingData.nodeID == 3)
{
    beratBerbaring = incomingData.value;
}
...
void checkRotation()
{
    ...
    {
        tft.setRotation(2);
         beratBadan = beratBerdiri;
       Serial.println(beratBerdiri);
    }
    else
    {
        tft.setRotation(1);
      beratBadan = beratBerbaring;
       Serial.println(beratBerbaring);
    }
...
if (cmd.startsWith("HX711_A="))
{
    ...
    if (nilai == "?")
    {
        ...
        Serial.println("Minta nilai HX711_A");
...
if (cmd.startsWith("HX711_B="))
{
    ...
    if (nilai == "?")
    {
        ...
        Serial.println("Minta nilai HX711_B");
...
if (cmd.startsWith("HX711_C="))
{
    ...
    if (nilai == "?")
    {
        ...
        Serial.println("Minta nilai HX711_C");
