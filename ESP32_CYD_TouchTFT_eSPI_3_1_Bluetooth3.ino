...
if (incomingData.nodeID == 183)
{
    Serial.print("HX711_R=");
    Serial.println(incomingData.value, 0);
}
...
if (cmd.startsWith("HX711_R"))
{
    ...
    esp_now_send(macHX711,
                 (uint8_t *)&sendData,
                 sizeof(sendData));

    Serial.println("Minta HX711_R...");
}
//================== HX711_A ==================
